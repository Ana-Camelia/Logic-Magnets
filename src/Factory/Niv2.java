 ...
 * @author Cami
 */
public class Niv2 extends JPanel implements Fabrica {

    JLabel id = new JLabel("Al doilea nivel");
    int x, y;
    ...
    public void afiseazaPanou(Container c) {
        ...
        System.out.println("Al doilea nivel");
